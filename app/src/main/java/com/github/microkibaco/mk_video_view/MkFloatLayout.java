 ...
 * </ul>
 * <p>在 xml 中采用  控制以上属性。</p>
 */
public class MkFloatLayout extends ViewGroup {
    ...
    /**
     * 设置最多可显示的子View个数 注意该方法不会改变子View的个数，只会影响显示出来的子View个数
     *
    ...
    /**
     * 设置最多可显示的行数 注意该方法不会改变子View的个数，只会影响显示出来的子View个数
     *
